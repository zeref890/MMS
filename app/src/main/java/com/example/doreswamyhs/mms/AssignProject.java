...
public class AssignProject extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.b103).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MyTaskParams myTaskParams=new MyTaskParams(id,num1,num2,num3,num4,num5,num6,num7,num8,num9,num10,num11,num12,num13,num14,num15,num16,num17,num18,num19,num20,num21,num22,num23,num24,num25,num26,num27,num28,num29,num30,date_str);
    ...
    {String add_info_url;
        ...
        {
            add_info_url="http://suphds.hostingerapp.com/assign_p.php";
            progDailog = new ProgressDialog(AssignProject.this);
