...
public class total_assign_fi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_assign_fi);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DateFormat df=new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
                String date_str=df.format(cal.getTime());
                MyTaskParams myTaskParams=new MyTaskParams(num1,num2,num3,num4,num5,num6,num7,num8,num9,num10,num11,num12,num13,date_str);
    ...
    private static class MyTaskParams{
        ...
        MyTaskParams(int num1,int num2,int num3,int num4,int num5,int num6,int num7,int num8,int num9,int num10,int num11,int num12,int num13,String date_str)
        {
    ...
    {String add_info_url;
        ...
        {
            add_info_url="http://suphds.hostingerapp.com/total_fi.php";
            progDailog = new ProgressDialog(total_assign_fi.this);
        ...
        {String time;
            ...
            try{
                ...
                String data_string= URLEncoder.encode("fibre_in","UTF-8")+"="+URLEncoder.encode(num1,"UTF-8")+"&"+
