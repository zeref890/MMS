...
public class total_assign_ci extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_assign_ci);
        ...
        findViewById(R.id.b104).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DateFormat df=new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
                String date_str=df.format(cal.getTime());
                MyTaskParams myTaskParams=new MyTaskParams(len,num_tenda,num_vsdl,num2,num3,num4,date_str);
    ...
    private static class MyTaskParams{
        ...
        MyTaskParams(String len,int num_tenda,int num_vsdl,int num2,int num3,int num4,String date_str)
        {
    ...
    {String add_info_url;
        ...
        {
            add_info_url="http://suphds.hostingerapp.com/total_ci.php";
            progDailog = new ProgressDialog(total_assign_ci.this);
        ...
        {String time,len;
            ...
            try{
                ...
                String data_string= URLEncoder.encode("dropWire","UTF-8")+"="+URLEncoder.encode(len,"UTF-8")+"&"+
